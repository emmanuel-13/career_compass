...
// Get exam system display based on country
const getExamSystem = (country) => {
    ...
    return systems[country?.toLowerCase()] || 'Standardized Tests';
};
...
// Format salary helper functions
...
const formatSalaryMid = (salary) => {
    ...
    return `${formatter.format(salary.min || 0)} - ${formatter.format(salary.max || 0)}`;
};
        ...
        <div class="max-w-6xl mx-auto" v-else-if="career">
            ...
            <div class="bg-white border rounded-3xl p-8 mb-8">
                ...
                <div class="mb-6" v-if="career.requirements">
                    <h3 class="font-semibold text-lg mb-2">{{ career.requirements.examSystem || getExamSystem(userStore.currentUser?.country) }}</h3>
